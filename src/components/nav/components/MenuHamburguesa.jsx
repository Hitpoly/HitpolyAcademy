      ...
      {loading ? (
        ...
        <List>
          <ListItem disablePadding>
            <ListItemButton onClick={() => handleCategoryClick("Todas")}>
              <ListItemText primary="Todas las categorías" primaryTypographyProps={{ fontWeight: 'bold', color: '#F21C63' }} />
            </ListItemButton>
          </ListItem>
          ...
          {categories.length > 0 ? (
            categories.map((categoria, index) => (
              <React.Fragment key={categoria.id}>
                <ListItem disablePadding>
                  <ListItemButton onClick={() => handleCategoryClick(categoria.nombre)}> 
